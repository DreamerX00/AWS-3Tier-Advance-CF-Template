package com.backend.gcp.aspect;
...
public class AuditAspect {
    ...
    @AfterReturning(
        pointcut = "execution(* com.backend.gcp.service.*Service.create(..)) || " +
                   "execution(* com.backend.gcp.service.*Service.update(..)) || " +
                   "execution(* com.backend.gcp.service.*Service.patch(..)) || " +
                   "execution(* com.backend.gcp.service.*Service.delete(..))",
        returning = "result"
    )
